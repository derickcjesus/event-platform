...
export type GetLessonsQQueryVariables = Exact<{ [key: string]: never; }>;


export type GetLessonsQQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, lessonType: LessonType, availableAt?: any | null, title: string, slug?: string | null }> };
...
export const GetLessonsQDocument = gql`
    query GetLessonsQ {
...
/**
 * __useGetLessonsQQuery__
 *
 * To run a query within a React component, call `useGetLessonsQQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetLessonsQQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetLessonsQQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetLessonsQQuery(baseOptions?: Apollo.QueryHookOptions<GetLessonsQQuery, GetLessonsQQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetLessonsQQuery, GetLessonsQQueryVariables>(GetLessonsQDocument, options);
      }
export function useGetLessonsQLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetLessonsQQuery, GetLessonsQQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetLessonsQQuery, GetLessonsQQueryVariables>(GetLessonsQDocument, options);
        }
export type GetLessonsQQueryHookResult = ReturnType<typeof useGetLessonsQQuery>;
export type GetLessonsQLazyQueryHookResult = ReturnType<typeof useGetLessonsQLazyQuery>;
export type GetLessonsQQueryResult = Apollo.QueryResult<GetLessonsQQuery, GetLessonsQQueryVariables>;